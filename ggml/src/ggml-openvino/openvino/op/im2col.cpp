...
OutputVector translate_im2col(const NodeContext & context) {
    ...
    const int32_t stride_w = s0;
    const int32_t stride_h = is_2D ? s1 : 1;
    const int32_t pad_w = p0;
    const int32_t pad_h = is_2D ? p1 : 0;
    const int32_t dil_w = d0;
    const int32_t dil_h = is_2D ? d1 : 1;
